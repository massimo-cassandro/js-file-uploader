...
/*!@preserve
   ...
   *
   */
function(e){!function(e){if(!a.isSuitableBrowser())return e.opts.silent_degradation||alert(e.strs.alert_unsuitable_browser),void(e.opts.unsuitable_browser_callback&&a.exec_callback(e.opts.unsuitable_browser_callback));e.css&&document.head.insertAdjacentHTML("beforeend",'<link rel="stylesheet" href="'+e.css+'" type="text/css" media="all">'),document.querySelectorAll(e.selector).forEach((t=>{let i=Object.assign({},t.dataset);delete i.fileUploader;let s=Object.assign({},e.opts,JSON.parse(t.dataset.fileUploader||"{}"),i);s.element=t;try{if(!s.uploader_url)throw new Error("FileUploader: missing `uploader_url` parameter");if(s.filetype=s.filetype.toLowerCase(),s.aspect_ratio_accuracy=10**+s.aspect_ratio_accuracy,-1!==["svg+img","img-svg","svg-img"].indexOf(s.filetype)&&(s.filetype="img+svg"),-1===Object.keys(a.mimetypes).indexOf(s.filetype))throw new Error("FileUploader: incorrect `filetype` parameter")}catch(e){console.error(e)}["input_text","templates","info_text_wrap_string","values","extra_fields"].forEach((e=>{try{"string"==typeof s[e]&&(s[e]=JSON.parse(s[e]))}catch(t){console.error(`FileUploader: the “${e}” parameter is not a valid json`),console.log(s.element),console.error(t)}}));for(let e in s)"string"==typeof s[e]&&-1!==["true","false","null"].indexOf(s[e].toLowerCase())&&(s[e]=JSON.parse(s[e]));if(s.img_aspect_ratio&&s.img_w&&s.img_h&&(console.error("FileUploader: the aspect ratio parameter will be ignored, because exact constraints have been set for width and height"),s.img_aspect_ratio=null),s.parsed_img_aspect_ratio=null,s.img_aspect_ratio)try{if(isNaN(s.img_aspect_ratio)){let e,t;-1!==s.img_aspect_ratio.indexOf("/")?[e,t]=s.img_aspect_ratio.split("/"):-1!==s.img_aspect_ratio.indexOf(":")&&([e,t]=s.img_aspect_ratio.split(":")),s.parsed_img_aspect_ratio=e&&t?+e/+t:Number(s.img_aspect_ratio)}else s.parsed_img_aspect_ratio=+s.img_aspect_ratio;if(s.parsed_img_aspect_ratio&&(s.parsed_img_aspect_ratio=Math.round((s.parsed_img_aspect_ratio+Number.EPSILON)*s.aspect_ratio_accuracy)/s.aspect_ratio_accuracy),isNaN(s.parsed_img_aspect_ratio)||!s.parsed_img_aspect_ratio)throw new Error}catch(e){console.error("FileUploader: incorrect aspect ratio parameter → "+s.img_aspect_ratio),s.img_aspect_ratio=null,s.parsed_img_aspect_ratio=null}new l({strs:e.strs,opts:s})}))}({selector:e.selector||"[data-file-uploader]",opts:Object.assign({},i,e.options||{}),css:e.css||null,strs:Object.assign({},t,e.local_strs||{})})},Object.defineProperty(e,"__esModule",{value:!0})}));
