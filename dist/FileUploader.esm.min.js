const e={alert_too_much_files:"Puoi selezionare un solo file!",alert_xhr_error:"Si &egrave; verificato un errore nel caricamento del file “<strong>{{file_name}}</strong>”.",alert_file_format_error:"Il file “<strong>{{file_name}}</strong>” è di un formato non consentito",alert_file_size_error:"Le dimensioni di “<strong>{{file_name}}</strong>” ({{file_size}}) superano il valore massimo consentito ({{allowed_size}})",alert_img_err_start_string:"L’immagine “<strong>{{file_name}}</strong>” non è corretta:",alert_img_exact_width_err:"Larghezza non corrispondente ({{image_dimension}}px invece di {{allowed_dimension}}px)",alert_img_min_width_err:"Larghezza inferiore a quella minima consentita ({{image_dimension}}px invece di {{allowed_dimension}}px)",alert_img_max_width_err:"Larghezza superiore a quella massima consentita ({{image_dimension}}px invece di {{allowed_dimension}}px)",alert_img_exact_height_err:"Altezza non corrispondente ({{image_dimension}}px invece di {{allowed_dimension}}px)",alert_img_min_height_err:"Altezza inferiore a quella minima consentita ({{image_dimension}}px invece di {{allowed_dimension}}px)",alert_img_max_height_err:"Altezza superiore a quella massima consentita ({{image_dimension}}px invece di {{allowed_dimension}}px)",alert_img_ratio_err:"La proporzione tra base e altezza dell’immagine non corrisponde a quella richiesta ({{aspect_ratio}})",no_img_text:"Nessuna immagine presente",no_doc_text:"Nessun file presente",remove_btn_text:"Elimina questo file",info_text_std_imgs:"immagini in formato <strong>JPEG</strong>, <strong>PNG</strong>, <strong>GIF</strong> o <strong>WEBP</strong>",info_text_imgs_svg:"immagini in formato <strong>JPEG</strong>, <strong>PNG</strong>, <strong>GIF</strong>, <strong>WEBP</strong> o <strong>SVG</strong>",info_text_imgs_svg_size_info_text:"<strong>Solo immagini non SVG:</strong> ",info_text_img_optimize_info:'Ottimizza le tue immagini prima di caricarle. <a href="https://squoosh.app/" target="_blank" rel="noopener noreferrer">Squoosh</a> è un ottimo (e gratuito) strumento per farlo.',info_text_svg_optimize_info:'È consigliabile ottimizzare i file SVG prima del caricamento, ad esempio tramite <a href="https://jakearchibald.github.io/svgomg/" target="_blank" rel="noopener noreferrer">SVGO</a>',info_text_img_fixed_size:"dimensioni: <strong>{{img_w}}&times;{{img_h}}px</strong>",info_text_img_equal_min_size:"larghezza e altezza non inferiori a <strong>{{img_min_w}}px</strong>",info_text_img_equal_max_size:"larghezza e altezza non superiori a <strong>{{img_max_w}}px</strong>",info_text_img_fixed_width:"larghezza <strong>{{img_w}}px</strong>",info_text_img_fixed_height:"altezza <strong>{{img_h}}px</strong>",info_text_img_width_range:"larghezza compresa tra <strong>{{img_min_w}}px</strong> e <strong>{{img_max_w}}px</strong>",info_text_img_min_width:"larghezza non inferiore a <strong>{{img_min_w}}px</strong>",info_text_img_max_width:"larghezza non superiore a <strong>{{img_max_w}}px</strong>",info_text_img_height_range:"altezza compresa tra <strong>{{img_min_h}}px</strong> e <strong>{{img_max_h}}px</strong>",info_text_img_min_height:"altezza non inferiore a <strong>{{img_min_h}}px</strong>",info_text_img_max_height:"altezza non superiore a <strong>{{img_max_h}}px</strong>",info_text_pdf_file:"file in formato <strong>PDF</strong>",info_text_svg_file:"immagini in formato <strong>SVG</strong>",info_text_max_filesize:"max <strong>{{max_filesize}}</strong>",info_text_img_aspect_ratio:"Il rapporto tra base e altezza dell’immagine deve essere esattamente pari a <strong>{{img_aspect_ratio}}</strong>",img_single_select_text:"Seleziona un’immagine",img_single_drag_text:"&hellip;oppure trascinala qui",img_multiple_select_text:"Seleziona una o pi&ugrave; immagini",img_multiple_drag_text:"&hellip;oppure trascinale qui",doc_single_select_text:"Seleziona un documento",doc_single_drag_text:"&hellip;oppure trascinalo qui",doc_multiple_select_text:"Seleziona uno o pi&ugrave; documenti",doc_multiple_drag_text:"&hellip;oppure trascinali qui",sortable_icon_title_text:"Trascina per cambiare l’ordinamento"},t={uploader_url:null,locales:"it-IT",debug:!1,ajax_method:"POST",disabled:!1,alert_api:(e,t,i="error")=>{window.alert(e.replace(/(<([^>]+)>)/gi,""))},filetype:"auto",accept:null,multiple:!1,required:!1,disable_submit:!1,template_main:'<div class="fupl-result"></div><div class="fupl-panel"><div class="fupl-button"><label><input type="file"></label><div class="fupl-dd-text"></div></div><div class="fupl-info-text"></div></div>',template_empty_img:'<div class="fupl-result-empty text-muted small font-italic">{{no_img_text}}}}</div>',template_empty_doc:'<div class="fupl-result-empty text-muted small font-italic">{{no_doc_text}}</div>',template_remove_btn:'<button type="button" class="close fupl-remove-trigger" aria-label="{{remove_btn_text}}" title="{{remove_btn_text}}"><span aria-hidden="true">&times;</span></button>',template_loading_element:'<div class="fupl-loading"><progress class="fupl-progress" max=100 value=0></progress></div>',template_alternative_loading_element:'<div class="spinner-grow text-primary" role="status"><span class="sr-only">Loading...</span></div',template_img_item_single:'<div class="fupl-item"><div class="fupl-remove"></div><img alt="Immagine caricata" class="img-fluid fupl-img"><div class="fupl-file-info"><div class="text-truncate fupl-file-name"></div><div class="fupl-file-size"></div><div class="fupl-extra-fields"></div></div></div>',template_img_item_multiple:'<div class="fupl-item"><div class="fupl-remove"></div><div class="fupl-img-wrapper"><img alt="Immagine caricata" class="img-fluid fupl-img" draggable="false"></div><div class="fupl-file-info"><div class="text-truncate fupl-file-name"></div><div class="fupl-file-size"></div></div><div class="fupl-extra-fields"></div><div class="fupl-sortable-icon"></div></div>',template_doc_item_single:'<div class="fupl-item"><div class="fupl-doc-wrapper"><div class="fupl-remove"></div><div class="fupl-doc text-truncate"><a class="text-truncate fupl-file-name fupl-url" draggable="false"></a></div></div><div class="small ml-1 text-nowrap fupl-file-size"></div><div class="fupl-extra-fields"></div><div class="fupl-sortable-icon"></div></div>',template_doc_item_multiple:null,wrapper_extra_class:null,element_dragover_class:"fupl-is-dragover",uploader_legend:!0,uploader_legend_text:null,uploader_legend_class:null,input_label_class:"btn btn-outline-primary btn-sm",show_info_text:!0,show_optimize_info:!0,info_text_wrap_string:["(",")"],info_text_join_string:" - ",custom_info_text:null,help_text:null,img_w:null,img_h:null,img_min_w:null,img_min_h:null,img_max_w:null,img_max_h:null,img_aspect_ratio:null,aspect_ratio_accuracy:2,max_filesize:null,varname:"file",registered_extra_field_varname:null,init_callback:null,upload_start_callback:null,upload_complete_callback:null,alternative_loading_func:null,values:[],delete_varname:"elimina_file[]",fancybox:!1,fancybox_anchor_markup:'<a class="fupl-url" data-fancybox="fupl-gallery"></a>',fancybox_callback_func:null,sortable:!1,sortable_varname:"fupl_order",sortable_icon:'<div title="{{sortable_icon_title_text}}"></div>',extra_fields:null},i={mimetypes:(()=>{let e={auto:null,img:["image/png","image/jpeg","image/pjpeg","image/gif","image/webp",".png",".jpg",".jpeg",".pjpg",".pjpeg",".gif",".webp"],pdf:["application/pdf",".pdf"],svg:["image/svg+xml",".svg",".svgz"]};return e["img+svg"]=e.img.concat(e.svg),e})(),isSuitableBrowser:()=>{if(-1!==navigator.userAgent.indexOf("MSIE")||navigator.appVersion.indexOf("Trident/")>-1||navigator.userAgent.indexOf("Trident/")>-1)return!1;var e=document.createElement("div");return("draggable"in e||"ondragstart"in e&&"ondrop"in e)&&"FormData"in window&&"FileReader"in window&&"fetch"in window},set_has_values:e=>{let t=e.opts.instance_result_wrapper.querySelectorAll(".fupl-item").length;e.opts.wrapper.dataset.hasValues=t?"true":"false",t||(e.opts.instance_result_wrapper.innerHTML=e.strs[`no_${e.opts._type}_text`])},parse_bytes_value:(e,t)=>{let i=1048576;return(e=+e)>=i?(e/i).toLocaleString(t,{maximumFractionDigits:1})+'<span class="fupl-unit">MB</span>':e<1024?Number((e/1024).toFixed(2)).toLocaleString(t,{maximumFractionDigits:2})+'<span class="fupl-unit">KB</span>':Math.round(e/1024).toLocaleString(t,{maximumFractionDigits:0})+'<span class="fupl-unit">KB</span>'},parse_max_filesize:(e,t)=>{if(e){var i,s,a;if(isNaN(e)){if(s=e.substr(-2,2).toUpperCase(),a=i=+e.substr(0,e.length-2),isNaN(i)||"KB"!==s&&"MB"!==s)return!1}else s="KB",a=i=+e;return i>=1024&&"KB"===s&&(s="MB",a=Math.round(i/1024*100)/100),"KB"===s?i*=1024:i=1024*i*1024,{maxbytes:i,feedback_size:a.toLocaleString(t,{maximumFractionDigits:"KB"===s?0:1})+'<span class="fupl-unit">'+s+"</span>"}}return null},exec_callback:(e,t)=>{try{if("string"==typeof e){let i=window;e.split(".").forEach((function(e){i=i[e]})),i(t)}else e(t)}catch(t){alert(`Error: “${e}” callback function doesn't exist`),console.error(t)}}};let s=null,a=!1;const r=()=>{s&&(s.classList.remove("fupl-item-sorting"),s.parentNode.querySelectorAll(".fupl-item-dragover").forEach((e=>{e.classList.remove("fupl-item-dragover")})),s.closest(".fupl").classList.remove("fupl-sorting")),s=null};function l(e,t,l=!1){try{let o=t.opts[`template_${t.opts._type}_item_${t.opts._mode}`];null===o&&"multiple"===t.opts._mode&&(o=t.opts[`template_${t.opts._type}_item_single`]);let n=document.createElement("div");n.innerHTML=o;let p=n.querySelector(".fupl-remove");p&&(p.innerHTML=t.opts.template_remove_btn);let _=n.querySelector(".fupl-file-name");_&&e.name&&(_.innerHTML=e.name,_.title=e.name);let m=n.querySelector(".fupl-file-size");if(m){let s="";"img"===t.opts._type&&e.wi&&e.he&&(s=e.wi+"&times;"+e.he+'<span class="fupl-unit">px</span>',e.size&&(s+=" &ndash; ")),e.size&&(s+=i.parse_bytes_value(e.size,t.opts.locales)),m.innerHTML=s}"img"===t.opts._type&&(n.querySelector(".fupl-img").src=e.src);let c=n.querySelector(".fupl-url");c&&e.url&&(c.href=e.url);let d=n.querySelector(".fupl-item");e.loading&&(d.classList.add("fupl-is-uploading"),d.insertAdjacentHTML("beforeend",t.opts.template_loading_element)),"single"===t.opts._mode?t.opts.instance_result_wrapper.innerHTML=n.innerHTML:(t.opts.instance_result_wrapper.querySelector(".fupl-item")||(t.opts.instance_result_wrapper.innerHTML=""),t.opts.instance_result_wrapper.insertAdjacentHTML("beforeend",n.innerHTML));let g=t.opts.instance_result_wrapper.querySelector(".fupl-item:last-child");g.dataset.id=e.id;let u=g.querySelector(".fupl-remove-trigger");if(u&&u.addEventListener("click",(()=>{g.remove();let s=e.rel_id?e.rel_id:e.id;s&&l&&t.opts.wrapper.insertAdjacentHTML("beforeend",`<input type="hidden" name="${t.opts.delete_varname}" value="${s}">`),i.set_has_values(t)})),t.opts.fancybox&&"img"===t.opts._type&&e.url&&t.opts.fancybox_anchor_markup){if(!g.querySelector("a.fupl-url")){let e=g.querySelector(".fupl-img"),i=document.createElement("div");i.innerHTML=t.opts.fancybox_anchor_markup,i=i.firstChild,e.parentNode.insertBefore(i,e),i.appendChild(e)}g.querySelector("a.fupl-url").setAttribute("href",e.url)}let f=g.querySelector(".fupl-extra-fields");if(null!==t.opts.extra_fields&&f&&(t.opts.extra_fields.forEach((i=>{f.insertAdjacentHTML("beforeend",i.markup.replace(/{{idx}}/g,e.id).replace(/{{val}}/g,l&&e[i.value_key]?e[i.value_key]:"").replace(/{{checked}}/g,l&&+e[i.value_key]?"checked":"").replace(/{{name}}/g,(l&&t.opts.registered_extra_field_varname?t.opts.registered_extra_field_varname:t.opts.varname)+"["+(i.use_rel_id&&e.rel_id?e.rel_id:e.id)+"]["+i.value_key+"]"))})),t.opts.sortable&&f.querySelectorAll("select, input, textarea").forEach((e=>{e.setAttribute("draggable","false"),["dragstart","drag","mousedown"].forEach((t=>{e.addEventListener(t,(e=>{"mousedown"!==t&&e.preventDefault(),e.stopPropagation()}))}))}))),t.opts.sortable){g.setAttribute("draggable",!0);let i=t.opts.instance_result_wrapper.querySelectorAll(".fupl-item").length-1;g.insertAdjacentHTML("beforeend",'<input type="hidden" class="fupl-sortable-order" name="'+(l&&t.opts.registered_extra_field_varname?t.opts.registered_extra_field_varname:t.opts.varname)+`[${e.id}][${t.opts.sortable_varname}]" value="${i}">`),t.opts.sortable_icon&&(g.querySelector(".fupl-sortable-icon").innerHTML=t.opts.sortable_icon.replace("{{sortable_icon_title_text}}",t.strs.sortable_icon_title_text)),function(e,t){e.addEventListener("dragstart",(function(e){a=t.wrapper.disabled,r(),a||(s=this,t.element.classList.add("fupl-sorting"),e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text","fupl-sorting"),this.classList.add("fupl-item-sorting"))}),!1),e.addEventListener("dragenter",(function(e){"fupl-sorting"!==e.dataTransfer.getData("text")||a||(e.stopPropagation&&e.stopPropagation(),this!==s&&this.classList.add("fupl-item-dragover"))}),!1),e.addEventListener("dragover",(function(e){return"fupl-sorting"!==e.dataTransfer.getData("text")||a||(e.preventDefault&&e.preventDefault(),e.dataTransfer.dropEffect="move",this!==s&&this.classList.add("fupl-item-dragover")),!1}),!1),e.addEventListener("dragleave",(function(){this.classList.remove("fupl-item-dragover")}),!1),e.addEventListener("drop",(function(e){return"fupl-sorting"!==e.dataTransfer.getData("text")||a||(e.stopPropagation&&e.stopPropagation(),e.preventDefault(),s&&(this.previousElementSibling===s&&this.nextElementSibling?this.parentNode.insertBefore(s,this.nextElementSibling):this.nextElementSibling?this.parentNode.insertBefore(s,this):this.parentNode.insertAdjacentElement("beforeend",s)),r()),!1}),!1),e.addEventListener("dragend",(function(e){"fupl-sorting"!==e.dataTransfer.getData("text")||a||(t.element.classList.remove("fupl-sorting"),r(),t.instance_result_wrapper.querySelectorAll(".fupl-sortable-order").forEach(((e,t)=>{e.value=t})))}),!1)}(g,t.opts)}return t.opts.instance_result_wrapper.querySelector(".fupl-item:last-child")}catch(e){console.error(e)}}function o(e,t){const s=e=>{const i=t.opts.element.closest("form");t.opts.disable_submit&&i&&i.querySelectorAll('[type="submit"]').forEach((t=>{t.disabled=e}))},a=function(e,a){s(!0);let r=l({id:e.id,name:e.file.name,url:null,src:a,wi:e.width,he:e.height,size:e.file.size,img_type:e.file.img_type,loading:!0},t),o=r.querySelector(".fupl-progress"),n=r.querySelector(".fupl-loading"),p=t.strs.alert_xhr_error.replace(/{{file_name}}/,e.file.name);t.opts.upload_start_callback&&i.exec_callback(t.opts.upload_start_callback,{item:e,img_preview:a,uploader_options:t}),new Promise((function(s,a){let l=new XMLHttpRequest;l.open(t.opts.ajax_method,t.opts.uploader_url,!0),l.onload=function(){if(l.status>=200&&l.status<400){const r=JSON.parse(l.responseText);r.error?(t.opts.alert_api(p,t),console.error(r.error),a()):(e.tmp_file=r.tmp_file,s()),t.opts.upload_complete_callback&&i.exec_callback(t.opts.upload_complete_callback,{item:e,server_error:r.error,fupl:t}),t.opts.debug&&(console.groupCollapsed("FileUploader ajax response"),console.log(r),console.groupEnd())}else t.opts.alert_api(p,t),console.error(l.status,l.statusText),console.error(l.responseText);a()},l.onerror=function(){t.opts.alert_api(p,t),t.opts.debug&&(console.error(l.status,l.statusText),console.error(l.responseText)),a()},l.upload.addEventListener("progress",(function(e){if(t.opts.alternative_loading_func)i.exec_callback(t.opts.alternative_loading_func,e,t);else{let i=Math.round(e.loaded/e.total*100)||0;o&&(e.lengthComputable?(i=i===1/0?100:i,r.querySelector(".fupl-progress").value=i):(n.innerHTML=t.opts.template_alternative_loading_element,o=null))}}),!1);let _=new FormData;_.append("file",e.file),l.send(_)})).then((function(){r.classList.remove("fupl-is-uploading"),r.querySelector(".fupl-loading").remove(),r.insertAdjacentHTML("beforeend",function(e,t){let i="",s={tmp_file:e.tmp_file,file_name:(e=>{let t="";const i={"à":"a","è":"e","é":"e","ì":"i","ò":"o","ù":"u","À":"A","È":"E","É":"E","Ì":"I","Ò":"O","Ù":"U","'":"_","|":"_","!":"_",'"':"_",$:"_","%":"_","&":"_","/":"_","(":"_",")":"_","=":"_","?":"_","^":"_","*":"_","[":"_","]":"_","ç":"c","@":"_","#":"_","<":"_",">":"_","ü":"u","Ü":"U","ñ":"n","Ñ":"N","~":"_",":":"_","\\":"_"};for(var s=0;s<e.length;s++)e[s]in i?t+=i[e[s]]:768===e.charCodeAt(s)||769===e.charCodeAt(s)?t+="":e.charCodeAt(s)>127?t+="_":t+=e.charAt(s);return t.replace(/ /g,"_").replace(/_+/g,"_")})(e.file.name),size:e.file.size,type:e.file.type};"img"===t._type&&(s.width=e.width,s.height=e.height);for(let a in s)i+='<input type="hidden" name="'+t.varname+"["+e.id+"]["+a+']" value="'+(null!==s[a]&&void 0!==s[a]?s[a]:"")+'">';return'<div class="fupl-hiddens">'+i+"</div>"}(e,t.opts)),i.set_has_values(t),s(!1)}),(function(){r.querySelector(".fupl-remove-trigger").click(),i.set_has_values(t)}))};e.length&&[...e].forEach((function(e,s){try{let r={id:"fupl_item_"+Date.now()+"_"+s,file:e,width:null,height:null,tmp_file:null,img_type:"img"===t.opts._type?"image/svg+xml"===e.type?"svg":"bmp":null};if(t.opts.accept.length){let i=e.name.split(".").pop().toLowerCase();if(-1===t.opts.accept.indexOf(e.type)&&-1===t.opts.accept.indexOf("."+i))throw t.strs.alert_file_format_error.replace(/{{file_name}}/,e.name)}if(null!==t.opts.max_filesize&&e.size>t.opts.max_filesize.maxbytes){let s=i.parse_bytes_value(e.size,t.opts.locales);throw t.strs.alert_file_size_error.replace(/{{file_name}}/,e.name).replace(/{{file_size}}/,s).replace(/{{allowed_size}}/,t.opts.max_filesize.feedback_size)}if("img"===t.opts._type){let i=new FileReader;i.addEventListener("load",(function(){let s=new Image;s.src=i.result,s.addEventListener("load",(function(){let l=[];r.width=s.width,r.height=s.height,"bmp"===r.img_type&&(t.opts.img_w&&s.width!==t.opts.img_w?l.push(t.strs.alert_img_exact_width_err.replace(/{{image_dimension}}/,s.width).replace(/{{allowed_dimension}}/,t.opts.img_w)):t.opts.img_min_w&&s.width<t.opts.img_min_w?l.push(t.strs.alert_img_min_width_err.replace(/{{image_dimension}}/,s.width).replace(/{{allowed_dimension}}/,t.opts.img_min_w)):t.opts.img_max_w&&s.width>t.opts.img_max_w&&l.push(t.strs.alert_img_max_width_err.replace(/{{image_dimension}}/,s.width).replace(/{{allowed_dimension}}/,t.opts.img_max_w)),t.opts.img_h&&s.height!==t.opts.img_h?l.push(t.strs.alert_img_exact_height_err.replace(/{{image_dimension}}/,s.height).replace(/{{allowed_dimension}}/,t.opts.img_h)):t.opts.img_min_h&&s.height<t.opts.img_min_h?l.push(t.strs.alert_img_min_height_err.replace(/{{image_dimension}}/,s.height).replace(/{{allowed_dimension}}/,t.opts.img_min_h)):t.opts.img_max_h&&s.height>t.opts.img_max_h&&l.push(t.strs.alert_img_max_height_err.replace(/{{image_dimension}}/,s.height).replace(/{{allowed_dimension}}/,t.opts.img_max_h))),t.opts.parsed_img_aspect_ratio&&Math.round((s.width/s.height+Number.EPSILON)*t.opts.aspect_ratio_accuracy)/t.opts.aspect_ratio_accuracy!==t.opts.parsed_img_aspect_ratio&&l.push(t.strs.alert_img_ratio_err.replace(/{{aspect_ratio}}/,t.opts.img_aspect_ratio)),l.length?t.opts.alert_api(t.strs.alert_img_err_start_string.replace(/{{file_name}}/,e.name)+"<br>\n<ul><li>"+l.join("</li>\n<li>")+"</li></ul>",t):a(r,i.result)}),!1)}),!1),i.readAsDataURL(e)}else a(r)}catch(e){t.opts.alert_api(e,t,"error")}}))}function n(e){try{let t=e.opts.element.querySelector('input[type="file"]'),s=e.opts.element.querySelector("label");if("auto"===e.opts.filetype){let i=[],s=[];null!==e.opts.accept&&(s=e.opts.accept.split(",").map((e=>e.trim()))),t&&t.getAttribute("accept")&&(i=t.getAttribute("accept").split(",").map((e=>e.trim()))),e.opts.accept=[...new Set([...s,...i])]}else e.opts.accept=i.mimetypes[e.opts.filetype];let a=i.parse_max_filesize(e.opts.max_filesize,e.opts.locales);if(!1===a)throw new Error(`FileUploader: incorrect value for “max_filesize” parameter (${e.opts.max_filesize})`);if(e.opts.max_filesize=a,e.opts.multiple=Boolean(e.opts.multiple||t&&t.hasAttribute("multiple")),e.opts.required=Boolean(e.opts.required||t&&t.hasAttribute("required")),e.opts.disabled=Boolean(e.opts.disabled||t&&t.hasAttribute("disabled")),e.opts._type=-1!==["img","svg","img+svg"].indexOf(e.opts.filetype)?"img":"doc",e.opts._mode=e.opts.multiple?"multiple":"single",!e.opts.uploader_legend_text&&s&&(e.opts.uploader_legend_text=s.innerHTML),e.opts.uploader_legend_text||(e.opts.uploader_legend_text="__legend not present__"),e.opts.element.classList.add("fupl"),e.opts.wrapper=document.createElement("fieldset"),e.opts.element.parentNode.insertBefore(e.opts.wrapper,e.opts.element),e.opts.wrapper.appendChild(e.opts.element),e.opts.wrapper.classList.add("fupl-wrapper"),e.opts.wrapper.classList.add("fupl-type-"+e.opts._type),e.opts.multiple&&e.opts.wrapper.classList.add("fupl-multiple"),e.opts.wrapper_extra_class&&e.opts.wrapper.classList.add(...e.opts.wrapper_extra_class.split(" ")),e.opts.uploader_legend){let t=["fupl-legend"];e.opts.uploader_legend_class&&t.push(e.opts.uploader_legend_class),e.opts.required&&t.push("required"),e.opts.element.insertAdjacentHTML("beforebegin","<legend"+(t.length?' class="'+t.join(" ")+'"':"")+">"+e.opts.uploader_legend_text+"</legend>"),e.opts.wrapper.classList.add("fupl-has-legend")}if(e.opts.element.innerHTML=e.opts.template_main,e.opts.instance_input=e.opts.element.querySelector('.fupl-panel input[type="file"]'),e.opts.instance_label=e.opts.element.querySelector(".fupl-panel label"),e.opts.instance_dd_text=e.opts.element.querySelector(".fupl-panel .fupl-dd-text"),e.opts.instance_info_text=e.opts.element.querySelector(".fupl-panel .fupl-info-text"),e.opts.instance_result_wrapper=e.opts.element.querySelector(".fupl-result"),e.opts.multiple&&e.opts.instance_input.setAttribute("multiple",""),null!==e.opts.accept&&e.opts.instance_input.setAttribute("accept",e.opts.accept.join(",")),e.opts.required&&(e.opts.wrapper.dataset.required="true"),e.opts.disabled&&(e.opts.wrapper.setAttribute("disabled",!0),e.opts.wrapper.setAttribute("aria-disabled",!0)),e.opts.instance_label.insertAdjacentHTML("beforeend",e.strs[`${e.opts._type}_${e.opts._mode}_select_text`]),e.opts.input_label_class&&e.opts.instance_label.classList.add(...e.opts.input_label_class.split(" ")),e.opts.instance_dd_text.innerHTML=e.strs[`${e.opts._type}_${e.opts._mode}_drag_text`],e.opts.show_info_text&&(e.opts.custom_info_text?e.opts.instance_info_text.innerHTML=e.opts.custom_info_text:e.opts.instance_info_text.innerHTML=function(e){let t=[];switch(e.opts.filetype){case"img":t.push(e.strs.info_text_std_imgs);break;case"img+svg":t.push(e.strs.info_text_imgs_svg);break;case"svg":t.push(e.strs.info_text_svg_file);break;case"pdf":t.push(e.strs.info_text_pdf_file)}if(null!==e.opts.max_filesize&&t.push(e.strs.info_text_max_filesize),"img"===e.opts.filetype||"img+svg"===e.opts.filetype){let i=[];e.opts.img_w&&e.opts.img_h?i.push(e.strs.info_text_img_fixed_size):e.opts.img_min_w&&e.opts.img_min_h&&e.opts.img_min_w===e.opts.img_min_h?i.push(e.strs.info_text_img_equal_min_size):e.opts.img_max_w&&e.opts.img_max_h&&e.opts.img_max_w===e.opts.img_max_h?i.push(e.strs.info_text_img_equal_max_size):(e.opts.img_w?i.push(e.strs.info_text_img_fixed_width):e.opts.img_min_w&&e.opts.img_max_w?i.push(e.strs.info_text_img_width_range):e.opts.img_min_w?i.push(e.strs.info_text_img_min_width):e.opts.img_max_w&&i.push(e.strs.info_text_img_max_width),e.opts.img_h?i.push(e.strs.info_text_img_fixed_height):e.opts.img_min_h&&e.opts.img_max_h?i.push(e.strs.info_text_img_height_range):e.opts.img_min_h?i.push(e.strs.info_text_img_min_height):e.opts.img_max_h&&i.push(e.strs.info_text_img_max_height),e.opts.img_aspect_ratio&&i.push(e.strs.info_text_img_aspect_ratio)),i.length&&t.push(("img+svg"===e.opts.filetype?e.strs.info_text_imgs_svg_size_info_text:"")+i.join(", "))}t=t.map((t=>t.replace(/{{img_w}}/,e.opts.img_w).replace(/{{img_h}}/,e.opts.img_h).replace(/{{img_min_w}}/,e.opts.img_min_w).replace(/{{img_min_h}}/,e.opts.img_min_h).replace(/{{img_max_w}}/,e.opts.img_max_w).replace(/{{img_max_h}}/,e.opts.img_max_h).replace(/{{img_aspect_ratio}}/,e.opts.img_aspect_ratio).replace(/{{max_filesize}}/,e.opts.max_filesize?e.opts.max_filesize.feedback_size:null)));let i=t.join(e.opts.info_text_join_string);return i=i.charAt(0).toUpperCase()+i.slice(1),e.opts.info_text_wrap_string&&i&&(i=e.opts.info_text_wrap_string[0]+i+e.opts.info_text_wrap_string[1]),"img"!==e.opts.filetype&&"img+svg"!==e.opts.filetype||(i+="<div>"+e.strs.info_text_img_optimize_info+"</div>"),"svg"!==e.opts.filetype&&"img+svg"!==e.opts.filetype||(i+="<div>"+e.strs.info_text_svg_optimize_info+"</div>"),i}(e),e.opts.help_text&&e.opts.instance_info_text.insertAdjacentHTML("beforeend",`<div class="fupl-help-text">${e.opts.help_text}</div>`)),e.opts.sortable){if(!e.opts.multiple||!e.opts.sortable_varname)throw new Error(`FileUploader: incorrect “sortable” settings:\n"sortable": ${e.opts.sortable?"true":"false"}\n"multiple": ${e.opts.multiple?"true":"false"}\n"sortable_varname": "${e.opts.sortable_varname}"`);e.opts.instance_result_wrapper.classList.add("fupl-sortable")}if(e.opts.values){if("object"!=typeof e.opts.values)throw new Error("FileUploader: incorrect “values” parameter");Array.isArray(e.opts.values)||(e.opts.values=[e.opts.values])}if(e.opts.values&&e.opts.values.length&&e.opts.values.forEach((t=>{l(t,e,!0)})),i.set_has_values(e),function(e){["dragenter","dragover","dragleave","drop"].forEach((t=>{e.opts.element.addEventListener(t,(e=>{e.preventDefault(),e.stopPropagation()}),!1)})),["dragover","dragenter"].forEach((t=>{e.opts.element.addEventListener(t,(()=>{e.opts.element.classList.add(e.opts.element_dragover_class)}),!1)})),["dragleave","dragend"].forEach((t=>{e.opts.element.addEventListener(t,(()=>{e.opts.element.classList.remove(e.opts.element_dragover_class)}),!1)})),e.opts.element.addEventListener("drop",(t=>{if(e.opts.element.classList.remove(e.opts.element_dragover_class),!e.opts.wrapper.hasAttribute("disabled")){let i=t.dataTransfer.files;i.length&&(!e.opts.multiple&&i.length>1?e.opts.alert_api(e.str.alert_too_much_files,e):o(i,e))}}),!1),e.opts.instance_input.addEventListener("change",(()=>{o(e.opts.instance_input.files,e)}))}(e),null!==e.opts.init_callback&&i.exec_callback(e.opts.init_callback,e),e.opts.fancybox&&null!==e.opts.fancybox_callback_func&&i.exec_callback(e.opts.fancybox_callback_func,e.opts),e.opts.debug){const t=Object.keys(e.opts).sort().reduce(((t,i)=>(t[i]=e.opts[i],t)),{});void 0===window.fileUploderOpts&&(window.fileUploderOpts={}),window.fileUploderOpts[e.opts.varname]=t,console.groupCollapsed("FileUploader options"),console.log(t),console.groupEnd()}}catch(e){console.error(e)}}
/*!@preserve
 *
 * FileUploader 2
